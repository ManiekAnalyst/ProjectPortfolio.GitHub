...
-- Cel: Projekt obejmuje analizę trendów, wzorców i wartości odstających w danych „Światowe Zwolnienia” w celu uzyskania wniosków.

--------------------------------------------------------------------------------
-- Step 1: Initial Exploration
-- Krok 1: Wstępna eksploracja
-- Purpose: Understand the dataset structure and get an overview of key statistics.
...
-- 2.1: Search for the company with the largest single layoff.
-- 2.1: Wyszukiwanie firmy z największym jednorazowym zwolnieniem.
...
-- 2.2: Analyze percentages of laid-off employees to identify extreme cases.
-- 2.2: Analiza procentów zwolnionych pracowników, aby zidentyfikować skrajne przypadki.
...
-- 2.3: Identification of companies where 100% of employees have been laid off.
-- 2.3: Identyfikacja firm, w których zwolniono 100% pracowników.
...
-- Insight:
-- Many of these cases are startups, including Quibi, which raised billions before going out of business.
-- Wniosek:
-- Wiele z tych przypadków to startupy, w tym Quibi, które zebrały miliardy przed zamknięciem.
...
-- 4.3: Distinguishing companies with layoffs well above industry averages.
-- 4.3: Wyróżnienie firm, w których liczba zwolnień znacznie przekracza średnią branżową.
