...
-- Cel: Upewnij się, że wszystkie kolumny mają poprawne typy danych.

-- Example: Adjust column data types as needed
-- Przykład: Dostosuj typy danych kolumn w razie potrzeby
